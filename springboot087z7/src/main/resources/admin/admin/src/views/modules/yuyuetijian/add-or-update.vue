		...
		>
			<template >
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="挂号编号" prop="guahaobianhao">
					<el-input v-model="ruleForm.guahaobianhao" placeholder="挂号编号" clearable  :readonly="ro.guahaobianhao"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="挂号编号" prop="guahaobianhao">
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="select" v-if="type!='info'"  label="项目名称" prop="xiangmumingcheng">
					<el-select :disabled="ro.xiangmumingcheng" v-model="ruleForm.xiangmumingcheng" placeholder="请选择项目名称" multiple>
						<el-option
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="date" v-if="type!='info'" label="检查时间" prop="jianchashijian">
					<el-date-picker
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.jianchashijian" label="检查时间" prop="jianchashijian">
...
export default {
	...
	methods: {
		...
		init(id,type) {
            ...
            this.$http({
				url: `option/xiangmumingcheng/xiangmumingcheng`,
				method: "get"
            }).then(({ data }) => {
				if (data && data.code === 0) {
