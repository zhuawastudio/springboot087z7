<template>
	<div class="addEdit-block" :style='{"padding":"30px","backgroundSize":" 100% 100%","flexWrap":"wrap","background":"url(http://codegen.caihongy.cn/20220730/cb2195540cde42b7abf14af25c15da3e.png) no-repeat  center bottom / 100% 100%","display":"flex","height":"calc(100vh - 120px)"}' style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'" label="挂号编号" prop="guahaobianhao">
					<el-input v-model="ruleForm.guahaobianhao" placeholder="挂号编号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.guahaobianhao" label="挂号编号" prop="guahaobianhao">
					<el-input v-model="ruleForm.guahaobianhao" placeholder="挂号编号" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="挂号人数" prop="renshu">
					<el-input v-model="ruleForm.renshu" placeholder="挂号人数" clearable  :readonly="ro.renshu"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="挂号人数" prop="renshu">
					<el-input v-model="ruleForm.renshu" placeholder="挂号人数" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="date" v-if="type!='info'" label="挂号时间" prop="guahaoshijian">
					<el-date-picker
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.guahaoshijian" label="挂号时间" prop="guahaoshijian">
...
export default {
    ...
    onSubmit() {
      ...
      if(parseFloat(this.ruleForm.jine)>parseFloat(this.ruleForm.yonghujine)){
        this.$message.error("挂号费不能超过用户金额");
        return
      }
