	...
	<div class="addEdit-block" :style='{"padding":"30px","backgroundSize":" 100% 100%","flexWrap":"wrap","background":"url(http://codegen.caihongy.cn/20220730/cb2195540cde42b7abf14af25c15da3e.png) no-repeat  center bottom / 100% 100%","display":"flex","height":"calc(100vh - 120px)"}' style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="就诊卡号" prop="jiuzhenkahao">
					<el-input v-model="ruleForm.jiuzhenkahao" placeholder="就诊卡号" clearable  :readonly="ro.jiuzhenkahao"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="就诊卡号" prop="jiuzhenkahao">
					<el-input v-model="ruleForm.jiuzhenkahao" placeholder="就诊卡号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="用户金额" prop="yonghujine">
					<el-input v-model="ruleForm.yonghujine" placeholder="用户金额" clearable  :readonly="ro.yonghujine"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="用户金额" prop="yonghujine">
					<el-input v-model="ruleForm.yonghujine" placeholder="用户金额" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="药品编号" prop="yaopinbianhao">
					<el-input v-model="ruleForm.yaopinbianhao" placeholder="药品编号" clearable  :readonly="ro.yaopinbianhao"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="药品编号" prop="yaopinbianhao">
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="总费用" prop="jine">
					<el-input v-model="jine" placeholder="总费用" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.jine" label="总费用" prop="jine">
					<el-input v-model="ruleForm.jine" placeholder="总费用" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="date" v-if="type!='info'" label="交费时间" prop="jiaofeishijian">
					<el-date-picker
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.jiaofeishijian" label="交费时间" prop="jiaofeishijian">
					<el-input v-model="ruleForm.jiaofeishijian" placeholder="交费时间" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="医生工号" prop="yishenggonghao">
					<el-input v-model="ruleForm.yishenggonghao" placeholder="医生工号" clearable  :readonly="ro.yishenggonghao"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="医生工号" prop="yishenggonghao">
...
export default {
	...
	computed: {
		...
		jine:{
			get: function () {
				return 1*this.ruleForm.yaopinjiage*this.ruleForm.shuliang
			}
		},
		...
		init(id,type) {
			...
			this.$http({
				...
				if (data && data.code === 0) {
					...
					if(((json.jiuzhenkahao!=''&&json.jiuzhenkahao) || json.jiuzhenkahao==0) && this.$storage.get("role")!="管理员"){
    ...
    onSubmit() {
      ...
      if(parseFloat(this.ruleForm.jine)>parseFloat(this.ruleForm.yonghujine)){
        this.$message.error("总费用不能超过用户金额");
        return
      }
